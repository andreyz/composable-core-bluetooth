...
extension BluetoothManager {
  ...
  public static func mock(
    ...
    connect: @escaping (AnyHashable, Peripheral.State, ConnectionOptions?) -> Effect<Never, Never> =
      { _, _, _ in
    ...
    retrieveConnectedPeripherals: @escaping (AnyHashable, [CBUUID]) -> [Peripheral.State] = {
      _, _ in
    ...
    registerForConnectionEvents: @escaping (AnyHashable, ConnectionEventOptions?) -> Effect<
      Never, Never
    > = { _, _ in
