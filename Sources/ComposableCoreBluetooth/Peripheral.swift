...
public enum Peripheral {
  ...
  public struct Environment {
    ...
    var writeCharacteristicValue:
      (Data, Characteristic, CBCharacteristicWriteType) -> Effect<Never, Never>
    ...
    init(
      ...
      writeCharacteristicValue: @escaping (Data, Characteristic, CBCharacteristicWriteType) ->
        Effect<Never, Never> = { _, _, _ in _unimplemented("writeCharacteristicValue") },
    ...
    public func discoverIncludedServices(
      _ uuids: [CBUUID]? = nil, for service: Service
    ) -> Effect<Never, Never> {
    ...
    public func setNotifyValue(
      _ enabled: Bool, for characteristic: Characteristic
    ) -> Effect<Never, Never> {
