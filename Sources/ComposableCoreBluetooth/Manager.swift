...
public struct BluetoothManager {
  ...
  var connect: (AnyHashable, Peripheral.State, ConnectionOptions?) -> Effect<Never, Never> = {
    _, _, _ in
...
extension BluetoothManager {
  public func create(
    id: AnyHashable, queue: DispatchQueue? = nil, options: InitializationOptions? = nil
  ) -> Effect<Action, Never> {
  ...
  public func connect(
    id: AnyHashable, to peripheral: Peripheral.State, options: ConnectionOptions? = nil
  ) -> Effect<Never, Never> {
    connect(id, peripheral, options)
  }

  public func cancelConnection(
    id: AnyHashable, with peripheral: Peripheral.State
  ) -> Effect<Never, Never> {
    cancelConnection(id, peripheral)
  }

  public func retrieveConnectedPeripherals(
    id: AnyHashable, services: [CBUUID]
  ) -> [Peripheral.State] {
  ...
  public func scanForPeripherals(
    id: AnyHashable, services: [CBUUID]? = nil, options: ScanOptions? = nil
  ) -> Effect<Never, Never> {
  ...
  public func registerForConnectionEvents(
    id: AnyHashable, options: ConnectionEventOptions? = nil
  ) -> Effect<Never, Never> {
...
extension BluetoothManager {
  ...
  public struct InitializationOptions {
    ...
    public init(
      showPowerAlert: Bool? = nil, restoreIdentifier: String? = nil
    ) {
    ...
    func toDictionary() -> [String: Any] {
      ...
      if let showPowerAlert = showPowerAlert {
        dictionary[CBCentralManagerOptionShowPowerAlertKey] = NSNumber(
          booleanLiteral: showPowerAlert)
      }
  ...
  public struct ConnectionOptions {
    ...
    func toDictionary() -> [String: Any] {
      ...
      if let notifyOnConnection = notifyOnConnection {
        dictionary[CBConnectPeripheralOptionNotifyOnConnectionKey] = NSNumber(
          booleanLiteral: notifyOnConnection)
      }

      if let notifyOnDisconnection = notifyOnDisconnection {
        dictionary[CBConnectPeripheralOptionNotifyOnDisconnectionKey] = NSNumber(
          booleanLiteral: notifyOnDisconnection)
      }

      if let notifyOnNotification = notifyOnNotification {
        dictionary[CBConnectPeripheralOptionNotifyOnNotificationKey] = NSNumber(
          booleanLiteral: notifyOnNotification)
      }

      #if os(iOS) || os(watchOS) || os(tvOS) || targetEnvironment(macCatalyst)
      if let enableTransportBridging = enableTransportBridging {
        dictionary[CBConnectPeripheralOptionEnableTransportBridgingKey] = NSNumber(
          booleanLiteral: enableTransportBridging)
      }
      #endif
  ...
  public struct ScanOptions: Equatable {
    ...
    public init(
      allowDuplicates: Bool? = nil, solicitedServiceUUIDs: [CBUUID]? = nil
    ) {
    ...
    init(
      ...
      allowDuplicates =
        (dictionary?[CBCentralManagerScanOptionAllowDuplicatesKey] as? NSNumber)?.boolValue
      solicitedServiceUUIDs =
        dictionary?[CBCentralManagerScanOptionSolicitedServiceUUIDsKey] as? [CBUUID]
    }
    ...
    func toDictionary() -> [String: Any] {
      ...
      if let allowDuplicates = allowDuplicates {
        dictionary[CBCentralManagerScanOptionAllowDuplicatesKey] = NSNumber(
          booleanLiteral: allowDuplicates)
      }

      if let solicitedServiceUUIDs = solicitedServiceUUIDs {
        dictionary[CBCentralManagerScanOptionSolicitedServiceUUIDsKey] =
          solicitedServiceUUIDs as NSArray
      }
  ...
  public struct ConnectionEventOptions {
    ...
    public init(
      peripheralUUIDs: [UUID]? = nil, serviceUUIDs: [CBUUID]? = nil
    ) {
  ...
  public struct RestorationOptions: Equatable {
    ...
    init(
      ...
      scanOptions = ScanOptions(
        from: dictionary[CBCentralManagerRestoredStateScanOptionsKey] as? [String: Any])
