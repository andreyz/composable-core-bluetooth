...
public struct Descriptor: Equatable {
  ...
  init?(
    from descriptor: CBDescriptor
  ) {
    guard let descriptorCharacteristic = descriptor.characteristic,
      let characteristic = Characteristic(from: descriptorCharacteristic)
    else { return nil }
    self.rawValue = descriptor
    self.identifier = descriptor.uuid
    self.characteristic = characteristic
    self.value = Self.anyToValue(uuid: identifier, descriptor.value)
  }

  init(
    identifier: CBUUID, characteristic: Characteristic, value: Value?
  ) {
    self.rawValue = nil
  ...
  static func anyToValue(uuid: CBUUID, _ value: Any?) -> Value? {
    ...
    case CBUUIDCharacteristicExtendedPropertiesString:
      return .characteristicExtendedProperties(value as? NSNumber)
    case CBUUIDCharacteristicUserDescriptionString:
      return .characteristicUserDescription(value as? String)
    case CBUUIDClientCharacteristicConfigurationString:
      return .clientCharacteristicConfiguration(value as? NSNumber)
    case CBUUIDServerCharacteristicConfigurationString:
      return .serverCharacteristicConfiguration(value as? NSNumber)
    case CBUUIDCharacteristicFormatString: return .characteristicFormat(value as? Data)
    case CBUUIDCharacteristicAggregateFormatString:
      return .characteristicAggregateFormat(value as? Data)
    default: return nil
    }
  }
}
  ...
  public enum Value: Equatable {
    ...
    var cbuuid: CBUUID {
      ...
      case .characteristicExtendedProperties:
        return CBUUID(string: CBUUIDCharacteristicExtendedPropertiesString)
      case .characteristicUserDescription:
        return CBUUID(string: CBUUIDCharacteristicUserDescriptionString)
      case .clientCharacteristicConfiguration:
        return CBUUID(string: CBUUIDClientCharacteristicConfigurationString)
      case .serverCharacteristicConfiguration:
        return CBUUID(string: CBUUIDServerCharacteristicConfigurationString)
      case .characteristicFormat: return CBUUID(string: CBUUIDCharacteristicFormatString)
      case .characteristicAggregateFormat:
        return CBUUID(string: CBUUIDCharacteristicAggregateFormatString)
      }
    }
  }
}
